...
The app is relies heavily on a community generated google doc spreadsheet (TBD: need to ask about credit/links, etc) and is inspired by various pre-existing tools already avaiable in the community.  This project is 50% persoanl learning, 50% customization for personal use in game, but if it helps others feel free to try it.
